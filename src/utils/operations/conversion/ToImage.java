package utils.operations.conversion;

import java.io.File;
import java.net.MalformedURLException;
import java.util.List;
import javafx.scene.image.Image;
import utils.operations.math.MaximumInteger;
...
public class ToImage {
    ...
    public static Image[][] convertListOfFileArray(List<File[]> listOfFiles) {
        ...
        Image[][] batch = new Image[listOfFiles.size()][MaximumInteger.maximumInteger_fromListOfArray(listOfFiles)];
