package com.project_studio.jlayerfx.util.io;
...
public class IO {
    ...
    public static void init() {
        ...
        FILE_CHOOSER.getExtensionFilters().addAll(FileUtils.IMAGE_EXTENSION_FILTER_LIST);
    ...
    public static File[] readDirectorySingle() {
        ...
        GUI.updateDirectoryText(selectedDirectory.getAbsolutePath());

        //Get Single/Base Directory
        File[] selectedDirectoryFiles = selectedDirectory.listFiles(FileUtils.IMAGE_FILE_NAME_FILTER);
    ...
    public static List<File[]> readDirectoryMultiple() {
        ...
        for (File file : files) {
            File[] temp = file.listFiles(FileUtils.IMAGE_FILE_NAME_FILTER);
    ...
    public static Object[] readBatchBaseImage() {
        ...
        //Set Base Image
    	String filePath = FileUtils.getPathFromFile(selectedImage);
        bisdoa[0] = new Image(filePath);
    ...
    public static void saveImage(Image image) {
        try {
            ...
            GUI.updateStatusText("Nothing to Save!");
        }
    }
